...
var __name__ = 'util';
export var _hp_line = function (label, cur, maxv) {
	return '{}: {}/{}'.format (label, cur, maxv);
};
export var _enemy_defense_effect = function (base_def, down_amt, down_turns) {
	return max (0, base_def - (down_turns > 0 ? down_amt : 0));
};
export var _clamp_int = function (v, lo, hi) {
