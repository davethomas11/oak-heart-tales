...
var __name__ = 'armor';
export var Armor =  __class__ ('Armor', [object], {
	__module__: __name__,
	get __init__ () {return __get__ (this, function (self, py_name, defense_bonus) {
		self.py_name = py_name;
		self.defense_bonus = defense_bonus;
	});},
	get __str__ () {return __get__ (this, function (self) {
		return 'Armor(name={}, defense_bonus={})'.format (self.py_name, self.defense_bonus);
	});}
});

//# sourceMappingURL=armor.map