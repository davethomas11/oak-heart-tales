...
var __name__ = 'weapon';
export var Weapon =  __class__ ('Weapon', [object], {
	__module__: __name__,
	get __init__ () {return __get__ (this, function (self, py_name, attack_bonus) {
		self.py_name = py_name;
		self.attack_bonus = attack_bonus;
	});},
	get __str__ () {return __get__ (this, function (self) {
		return 'Weapon(name={}, attack_bonus={})'.format (self.py_name, self.attack_bonus);
	});}
});

//# sourceMappingURL=weapon.map